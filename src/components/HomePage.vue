      ...
      <div class="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
        ...
        >
          ...
          <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2022 QuickAdmit, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
...
/* const includedFeatures = [
 *   "24/7 eligibility, and benefit check",
 *   "Accreditation requirement for each level of care",
 *   "OON payer reimbursement rate percentage allowed on charges based on alpha prefix, plan sponsor, employer",
 *   "Official QuickAdmit t-shirt",
 * ]; */
