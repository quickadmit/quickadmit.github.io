import{_ as m,o as c,c as l,a as e,n as d,F as g,e as h,f as u,t as p}from"./index-DDLAxcf9.js";const y="/assets/admit_img-B1HeQ_8R.png",f="/assets/vob_img-CWViaYKX.png",b="/assets/report_img-DsXf9uu6.png",v="/assets/alert_img-BnC640Vq.png",_="/assets/security_img-BAXz5N8u.png",k="/assets/phone_img-CIwcwuTA.png",B="/assets/reimb_img-TiZeKydB.png",I={name:"ProductsView",data(){return{isHeaderVisible:!1,visibleCards:[],productSuite:[{title:"Inquiries & Lead Management",type:"Core Platform",accent:"#7B5CFF",description:`Uptime You Can Depend On.<br/>
...
ensuring every admission is backed by a clear understanding of its economic impact.`,image:B},{title:"Custom Logic Alerts",type:"Workflow Automation",accent:"#7B5CFF",description:`Visual Intelligence at a Glance.<br/>
...
our mobile-optimized interface ensures you have the power to verify, alert, and admit without ever being tethered to a workstation.`,image:k},{title:"Security & Compliance",type:"Trust & Security",accent:"#7B5CFF",description:`Data Security You Can Trust.<br/>
...
This creates a secure "tunnel" for your data, making it unreadable to unauthorized parties.`,image:_}]}},mounted(){this.initObserver()},methods:{initObserver(){const r=new IntersectionObserver(a=>{a.forEach(i=>{if(i.isIntersecting)if(i.target===this.$refs.header)this.isHeaderVisible=!0;else{const s=parseInt(i.target.getAttribute("data-index"));this.visibleCards.includes(s)||this.visibleCards.push(s)}})},{threshold:.2});r.observe(this.$refs.header),this.productSuite.forEach((a,i)=>{const s=this.$refs["product-"+i][0];s.setAttribute("data-index",i),r.observe(s)})}}},w={class:"products-page"},C={class:"section"},S={class:"container"},A={class:"column is-7 px-6"},V=["innerHTML"],F={class:"column is-5"},x={class:"product-image-container"},O=["src","alt"];function H(r,a,i,s,o,T){return c(),l("div",w,[e("header",{class:d(["products-hero reveal",{"is-visible":o.isHeaderVisible}]),ref:"header"},[...a[0]||(a[0]=[e("div",{class:"container has-text-centered"},[e("h1",{class:"header-title mb-4"}," The QuickAdmit Product Suite "),e("p",{class:"header-subtitle"}," Comprehensive tools designed to eliminate administrative friction and prioritize patient care. ")],-1)])],2),e("section",C,[e("div",S,[(c(!0),l(g,null,h(o.productSuite,(t,n)=>(c(),l("div",{key:n,class:d(["product-card-wrapper reveal",{"is-visible":o.visibleCards.includes(n)}]),ref_for:!0,ref:"product-"+n},[e("div",{class:"product-card box",style:u({boxShadow:"0 12px 30px rgba(15,15,20,0.06), 0 3px 8px rgba(15,15,20,0.04)",borderColor:t.accent+"30"})},[e("div",{class:d(["columns is-vcentered",{"is-reversed":n%2!==0}])},[e("div",A,[e("span",{class:"product-badge",style:u({background:t.accent+"15",color:t.accent})},p(t.type),5),e("h2",{class:"product-title",style:u({color:t.accent})},p(t.title),5),e("p",{class:"product-description",innerHTML:t.description},null,8,V)]),e("div",F,[e("div",x,[e("img",{src:t.image,alt:t.title,class:"product-ui-img"},null,8,O)])])],2)],4)],2))),128))])])])}const D=m(I,[["render",H],["__scopeId","data-v-5fd2b3ff"]]);export{D as default};
