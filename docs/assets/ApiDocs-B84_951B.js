import{_ as b,o as n,c as r,a as e,F as l,e as c,t as a,g as u,n as h,h as f}from"./index-CyKzu2rJ.js";const v="/assets/api_hero_security-vke8F8fY.png",_=`curl --request GET \\
  --url 'https://app.quickadmit.com/api/v2/payers?page=1&limit=25' \\
  --header 'Authorization: Bearer <your_api_key>'`,g=`{
  "payer": {
    "id": 1234,
...
}`,response:y},{method:"GET",path:"/blanket-vobs",title:"List Blanket VOBs",description:"Returns stored Blanket VOB discovery searches. The example filters by member and payer.",query:["memberId","payerId","page","limit"],queryExample:"/blanket-vobs?memberId=QA123456789&payerId=1234&page=1&limit=25",request:null,response:w},{method:"GET",path:"/blanket-vobs/{id}",title:"Get Blanket VOB",description:"Returns one Blanket VOB with readable payer and plan details.",query:[],request:null,response:y}],fieldSections:[{title:"Create request fields",description:"Use synthetic test patients when building locally or sharing examples.",fields:[{name:"providerId",description:"Provider ID returned by GET /providers."},{name:"patientStateId",description:"Patient state ID used for discovery."},{name:"patientFirstName",description:"Patient first name."},{name:"patientLastName",description:"Patient last name."},{name:"patientDOB",description:"Patient date of birth in MM/DD/YYYY format."},{name:"doS_StartDate",description:"Date-of-service start date in MM/DD/YYYY format."},{name:"doS_EndDate",description:"Date-of-service end date in MM/DD/YYYY format."},{name:"patientSSN",description:"Optional patient SSN when required for discovery."}]},{title:"List filters",description:"Use these query parameters on GET /blanket-vobs.",fields:[{name:"memberId",description:"Filter results by member ID."},{name:"payerId",description:"Filter results by payer ID."},{name:"page",description:"Page number. Defaults to 1."},{name:"limit",description:"Page size. Defaults to 25 and cannot exceed 100."}]},{title:"Response fields",description:"Detail responses include payer-specific plan details when available.",fields:[{name:"blanket_vob.id",description:"QuickAdmit Blanket VOB ID."},{name:"remote_id",description:"Discovery request ID when available."},{name:"patient_first_name / patient_last_name",description:"Patient name stored on the Blanket VOB."},{name:"member_id",description:"Member ID found or used for the search."},{name:"status",description:"Request status, for example pending, complete, or error."},{name:"provider",description:"Provider object with id and name."},{name:"payers",description:"Payer results found for the patient."},{name:"payers[].plan_response",description:"Readable plan details such as deductible, out-of-pocket, contacts, and service details."},{name:"remote_errors",description:"Result errors returned with an otherwise stored result."}]}]}],T=[{id:"overview",label:"Overview"},{id:"quickstart",label:"Quickstart"},{id:"authentication",label:"Authentication"},{id:"providers",label:"Providers"},{id:"payers",label:"Payers"},{id:"service-codes",label:"Service Codes"},{id:"eligibility",label:"Eligibility"},{id:"blanket-vob",label:"Blanket VOB"},{id:"pagination",label:"Pagination and errors"},{id:"testing",label:"Testing safely"}],B={name:"ApiDocs",data(){return{navItems:T,activeSectionId:"overview",activeSectionFrame:null,heroImage:v,quickstartCode:_,errorExample:q,endpointGroups:D,workflowSteps:[{number:"1",title:"Sign in",body:"Log in to the QuickAdmit account that has API Access enabled."},{number:"2",title:"Open API Access",body:"Go to API Access from account settings and review the keys issued for the account."},{number:"3",title:"Copy a key",body:"Copy an active API key and store it securely in your application configuration."},{number:"4",title:"Call the API",body:"Use any REST client or backend HTTP client and include Authorization: Bearer <your_api_key> on every request."}]}},mounted(){window.addEventListener("scroll",this.queueActiveSectionUpdate,{passive:!0}),window.addEventListener("resize",this.queueActiveSectionUpdate),this.$nextTick(this.updateActiveSection)},beforeUnmount(){window.removeEventListener("scroll",this.queueActiveSectionUpdate),window.removeEventListener("resize",this.queueActiveSectionUpdate),this.activeSectionFrame&&window.cancelAnimationFrame(this.activeSectionFrame)},methods:{queueActiveSectionUpdate(){this.activeSectionFrame||(this.activeSectionFrame=window.requestAnimationFrame(()=>{this.activeSectionFrame=null,this.updateActiveSection()}))},updateActiveSection(){const d=this.navItems.map(p=>document.getElementById(p.id)).filter(Boolean);if(!d.length)return;let t=d[0].id;d.forEach(p=>{p.getBoundingClientRect().top<=140&&(t=p.id)}),window.innerHeight+window.scrollY>=document.documentElement.scrollHeight-4&&(t=d[d.length-1].id),this.activeSectionId=t}}},R={class:"api-docs-page"},M={class:"docs-shell"},O={class:"docs-sidebar","aria-label":"API documentation navigation"},L=["href","aria-current"],C={class:"docs-content"},H={class:"docs-header",id:"overview"},N={class:"docs-header-content"},Q={class:"docs-header-visual","aria-hidden":"true"},F=["src"],G={class:"doc-section",id:"quickstart"},V={class:"step-grid"},Y={class:"code-block"},U=["id"],X={class:"section-heading"},J={class:"endpoint-header"},z={key:0,class:"query-example"},Z={key:0},j={class:"code-block"},W={class:"code-block"},K={class:"field-section-grid"},$={key:0},ee={class:"field-list"},te={class:"doc-section",id:"pagination"},ie={class:"code-block"};function ae(d,t,p,se,o,ne){return n(),r("div",R,[e("section",M,[e("aside",O,[t[0]||(t[0]=e("div",{class:"sidebar-title"},"QuickAdmit API",-1)),(n(!0),r(l,null,c(o.navItems,s=>(n(),r("a",{key:s.id,href:"#"+s.id,class:h({active:o.activeSectionId===s.id}),"aria-current":o.activeSectionId===s.id?"location":null},a(s.label),11,L))),128))]),e("article",C,[e("header",H,[e("div",N,[t[1]||(t[1]=e("div",{class:"docs-header-copy"},[e("div",{class:"eyebrow"},"API documentation"),e("h1",null,"QuickAdmit API"),e("p",null," Build directly into QuickAdmit's eligibility, Blanket VOB, and payer workflows. The API is designed around a single app entry point, API-key authentication, and account-level access. ")],-1)),e("div",Q,[e("img",{src:o.heroImage,alt:""},null,8,F)])])]),e("section",G,[t[2]||(t[2]=e("h2",null,"Quickstart",-1)),t[3]||(t[3]=e("p",null," Start in the QuickAdmit app. Sign in to your account, open API Access, and copy an active API key. Every API request must include that key in the authorization header. After that, use any REST client or backend service to call the endpoints below; each workflow is explained in more detail in the following sections. ",-1)),e("div",V,[(n(!0),r(l,null,c(o.workflowSteps,s=>(n(),r("div",{key:s.title,class:"step-item"},[e("span",null,a(s.number),1),e("div",null,[e("h3",null,a(s.title),1),e("p",null,a(s.body),1)])]))),128))]),e("pre",Y,[e("code",null,a(o.quickstartCode),1)])]),t[8]||(t[8]=u('<section class="doc-section" id="authentication" data-v-5d27bf2f><h2 data-v-5d27bf2f>Authentication and access</h2><p data-v-5d27bf2f> QuickAdmit admins generate API keys after API Access is purchased. Customers can view their issued keys in the app, but key creation is handled by QuickAdmit operations. Treat API keys like production credentials and rotate them through support if they are exposed. </p><div class="info-table" data-v-5d27bf2f><div data-v-5d27bf2f><strong data-v-5d27bf2f>Header</strong><code data-v-5d27bf2f>Authorization: Bearer qa_live_example</code></div><div data-v-5d27bf2f><strong data-v-5d27bf2f>Scope</strong><span data-v-5d27bf2f>API keys can only access data for the account they were issued for.</span></div><div data-v-5d27bf2f><strong data-v-5d27bf2f>Access requirements</strong><span data-v-5d27bf2f>Active subscription plus paid API Access. Add-on endpoints require their product entitlement.</span></div></div></section>',1)),(n(!0),r(l,null,c(o.endpointGroups,s=>(n(),r("section",{id:s.id,key:s.id,class:"doc-section"},[e("div",X,[e("h2",null,a(s.title),1),e("p",null,a(s.description),1)]),(n(!0),r(l,null,c(s.endpoints,i=>(n(),r("section",{key:i.method+i.path,class:"endpoint-block"},[e("div",J,[e("span",{class:h(["method-badge","method-"+i.method.toLowerCase()])},a(i.method),3),e("code",null,a(i.path),1)]),e("h3",null,a(i.title),1),e("p",null,a(i.description),1),i.queryExample?(n(),r("div",z,[t[4]||(t[4]=e("strong",null,"Example",-1)),e("code",null,a(i.queryExample),1)])):f("",!0),e("div",{class:h(["endpoint-examples",{"single-example":!i.request}])},[i.request?(n(),r("div",Z,[t[5]||(t[5]=e("h4",null,"Request",-1)),e("pre",j,[e("code",null,a(i.request),1)])])):f("",!0),e("div",null,[t[6]||(t[6]=e("h4",null,"Response",-1)),e("pre",W,[e("code",null,a(i.response),1)])])],2)]))),128)),e("div",K,[(n(!0),r(l,null,c(s.fieldSections,i=>(n(),r("div",{key:i.title,class:"field-panel"},[e("h3",null,a(i.title),1),i.description?(n(),r("p",$,a(i.description),1)):f("",!0),e("div",ee,[(n(!0),r(l,null,c(i.fields,m=>(n(),r("div",{key:m.name},[e("code",null,a(m.name),1),e("span",null,a(m.description),1)]))),128))])]))),128))])],8,U))),128)),e("section",te,[t[7]||(t[7]=u('<h2 data-v-5d27bf2f>Pagination, filters, and errors</h2><div class="two-column" data-v-5d27bf2f><div data-v-5d27bf2f><h3 data-v-5d27bf2f>Pagination</h3><p data-v-5d27bf2f> List endpoints default to <code data-v-5d27bf2f>page=1</code> and <code data-v-5d27bf2f>limit=25</code>. The maximum limit is <code data-v-5d27bf2f>100</code>. Responses include <code data-v-5d27bf2f>total</code>, <code data-v-5d27bf2f>page</code>, and <code data-v-5d27bf2f>limit</code>. </p></div><div data-v-5d27bf2f><h3 data-v-5d27bf2f>Error envelope</h3><p data-v-5d27bf2f> Handler errors use a consistent JSON envelope. Authentication middleware can return <code data-v-5d27bf2f>401</code> or <code data-v-5d27bf2f>403</code> before the request reaches a handler. </p></div></div>',2)),e("pre",ie,[e("code",null,a(o.errorExample),1)])]),t[9]||(t[9]=u('<section class="doc-section" id="testing" data-v-5d27bf2f><h2 data-v-5d27bf2f>Testing safely</h2><p data-v-5d27bf2f> Use synthetic patient data when building locally or sharing examples. Only send production PHI from approved systems and never paste API keys, patient identifiers, or payer responses into public tickets or chat tools. </p><div class="testing-callout" data-v-5d27bf2f><strong data-v-5d27bf2f>Rate limiting</strong><span data-v-5d27bf2f> Keep API traffic steady and avoid large request bursts. If a request returns <code data-v-5d27bf2f>429 Too Many Requests</code>, pause and retry with exponential backoff. </span></div><ul class="check-list" data-v-5d27bf2f><li data-v-5d27bf2f>Store API keys in a secret manager or encrypted environment variable.</li><li data-v-5d27bf2f>Use payer schemas to validate required fields before submitting inquiries.</li><li data-v-5d27bf2f>Handle eligibility result errors returned inside <code data-v-5d27bf2f>remote_errors</code>.</li><li data-v-5d27bf2f>Use retries with backoff for temporary <code data-v-5d27bf2f>429</code> and <code data-v-5d27bf2f>5xx</code> responses.</li></ul></section>',1))])])])}const oe=b(B,[["render",ae],["__scopeId","data-v-5d27bf2f"]]);export{oe as default};
